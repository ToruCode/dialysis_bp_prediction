...
透析中のパラメータ(プライバシー保護のため加工済み)（除水量・体重変化・液温など）から  
...
| 指標   | 収縮期血圧      | 拡張期血圧      | 脈拍       |
| ---- | ---------- | ---------- | -------- |
| RMSE(二乗平均平方根誤差) | 27.85 mmHg | 14.17 mmHg | 3.35 bpm |
| MAE(平均絶対誤差)  | 22.77 mmHg | 11.55 mmHg | 2.72 bpm |
| R²(決定係数)   | -0.086     | -0.080     | -0.012   |
